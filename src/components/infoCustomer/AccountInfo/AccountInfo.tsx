...
const AccountInfo = () => {
  const [phoneNumber, setPhoneNumber] = useState('0931247957');
  ...
  return (
    <div className="bg-gray-100 p-6 w-full rounded-md">
      ...
      <div className="bg-white p-4 shadow-md rounded-md mb-6">
        ...
        <p>Bạn - {phoneNumber} <a href="#" className="text-blue-500">Sửa</a></p>
      </div>
